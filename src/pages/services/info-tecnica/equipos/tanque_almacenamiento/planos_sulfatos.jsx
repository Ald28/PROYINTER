...
const planos_sulfatos = () => {
  const datasheetList = [
    {
      id: 1,
      title: 'MB_MEC_ARREG TANK 0.5M3 SULF_001',
      link: '/files/MB_MEC_ARREG TANK 0.5M3 SULF_001.pdf',
      fecha: '22-02-2024'
    },
    {
      id: 2,
      title: 'MB_MEC_ARREG TANK 0.5M3 SULF_002',
      link: '/files/MB_MEC_ARREG TANK 0.5M3 SULF_002.pdf',
      fecha: '22-02-2024'
    }
  ];
    ...
    <div className="installed-base">
      <nav aria-label="breadcrumb">
        <ol className="breadcrumb">
          ...
          <li className="breadcrumb-item">
            <Link className="btn btn-link p-0" to="/cliente/informacion-tecnica-equipos/equipos/2">Tanque de Sulfatos</Link>
          </li>
...
export default planos_sulfatos;
